...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk20-jdk < 20.0.2-2
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk20-jdk-base < 20.0.2-2
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk20-jre < 20.0.2-2
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk20-jre-base < 20.0.2-2
...
Obsoletes:	openjdk20-jre-base-X11 < 20.0.2-2
...
Obsoletes:	openjdk20-jre-base-freetype < 20.0.2-2
...
Obsoletes:	jar
Obsoletes:	openjdk20-jar < 20.0.2-2
